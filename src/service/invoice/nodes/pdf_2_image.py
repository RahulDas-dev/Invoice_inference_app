...
class Pdf2ImgConverter:
    def __init__(self, cfg: InvoiceInferConfig) -> None:
        self.input_path: Path = Path(cfg.UPLOADS_DEFAULT_DEST)
        self.output_path: Path = Path(cfg.UPLOADS_DEFAULT_DEST) / "pdf2img"
